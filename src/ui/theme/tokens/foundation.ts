export const radius = Object.freeze({ none: 0, sm: 6, md: 10, lg: 16, pill: 999 });
export const sizing = Object.freeze({ touchTarget: 44, iconSm: 16, iconMd: 24, iconLg: 32, boardCellMin: 44 });
export const opacity = Object.freeze({ disabled: 0.45, muted: 0.68, pressed: 0.82, overlay: 0.52 });
