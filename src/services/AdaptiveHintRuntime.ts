import { getLogicalHint } from "../game/engine";
import type { GameSession } from "../types/Game";
import type { Puzzle } from "../types/Puzzle";
import type { AdaptiveHint, HintLevel } from "../types/PremiumGameplay";

function equationLabel(ids: readonly string[]): string {
...
export function buildAdaptiveHint(
  ...
  const logical = getLogicalHint(puzzle, session);
