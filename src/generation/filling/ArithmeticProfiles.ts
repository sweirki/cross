...
export interface ArithmeticProfile {
  readonly id: string;
  readonly difficulty: DifficultyTier;
  readonly policy: ArithmeticPolicy;
  readonly operators: readonly Exclude<Operator, "=">[];
  readonly operatorWeights: Readonly<Record<Exclude<Operator, "=">, number>>;
  readonly maximumSearchNodes: number;
  readonly maximumRepeatedValueRatio: number;
  readonly maximumTrivialEquationRatio: number;
}

const PROFILES: Readonly<Record<DifficultyTier, ArithmeticProfile>> = {
  easy: {
...
export function arithmeticProfileForDifficulty(difficulty: DifficultyTier): ArithmeticProfile {
