...
exports.resolveVisualBreakpoint = resolveVisualBreakpoint;
exports.resolveBoardLayout = resolveBoardLayout;
exports.fitBoardCellSize = fitBoardCellSize;
function resolveVisualBreakpoint(width) {
...
function resolveBoardLayout(width) {
...
function fitBoardCellSize(viewportWidth, viewportHeight, columns, rows) {
