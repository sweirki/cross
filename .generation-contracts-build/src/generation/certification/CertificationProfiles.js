...
exports.certificationProfileForDifficulty = certificationProfileForDifficulty;
...
function certificationProfileForDifficulty(difficulty) {
    const base = PROFILES[difficulty];
    const tuning = (0, TuningProfiles_1.productionTuningProfile)(difficulty);
